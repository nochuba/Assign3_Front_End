            ...
            >
              <v-layout row>
                <v-flex xs4>
                  <v-card>
                    <v-img
                      :src="require('@/assets/images/cust_image.jpg')" height="200px">
                    </v-img>
                ...
                <v-flex xs4>
                  <v-card>
                    <v-img
                      :src="require('@/assets/images/non_stock.jpg')" height="200px">
                    </v-img>
                ...
                <v-flex xs4>
                  <v-card>
                   <v-img
                      :src="require('@/assets/images/stock_market4.jpg')" height="200px">
                    </v-img>
